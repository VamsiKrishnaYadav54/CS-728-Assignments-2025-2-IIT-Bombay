...
def query_to_docs_attention_heads(attentions, query_span, doc_spans, selected_heads):
    ...
    for layer_idx, head_idx in selected_heads:
        head_attention = attentions[layer_idx][0, head_idx]  # [seq_len, seq_len]
...
if __name__ == '__main__':
    ...
    print("\n" + "="*60)
    print("PART 3 RESULTS - Retrieval Heads")
    print("="*60)
    ...
    # Save results
    with open(f"results_part3_heads{args.max_heads}.json", "w") as f:
        json.dump({
    ...
    print(f"Results saved to results_part3_heads{args.max_heads}.json")
